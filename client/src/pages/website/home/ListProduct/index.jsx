                ...
                <div className="wp__list-product">
                    {products.map(product => (
                        <div className="wp__list-product-item" key={product._id}>
                            <Link to="" className="product_item-img-focus">
                                <img className="product__item-img-hover" src={product && product.image[0]} alt="image product" />
                                <div className="product__item-action">
                                    <Link to="">Xem chi tiết<i className="bi bi-eye"></i></Link>
                                    <Link to="">Mua ngay<i className="bi bi-cart3"></i></Link>
                                </div>
                            </Link>
                            <p className="product__item-name"><Link to="#">{product.name}</Link></p>
                            ...
                            {product.price_sale > 0 ?
                                ...
                                :
                                <span className="product__item-price-notsale">{convertNumber(product.price_default)}đ</span>
                            }
