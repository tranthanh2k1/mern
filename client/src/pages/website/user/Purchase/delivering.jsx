...
const DeliveringUserPage = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const { data } = await axios.post(`${API}/order/user/status`, { status: 'DELIVERING' }, {
                    headers: {
                    ...
                    <div style={{ backgroundColor: '#fffefb' }}>
                        ...
                        <div className='user__purchase-order-item-footer'>
                            ...
                            {itemData.order.status === 'PROCESSING' && (
                                <div
                                    className='user__purchase-cancel'
                                    onClick={() => {
                                        setShow(true)
...
export default DeliveringUserPage
